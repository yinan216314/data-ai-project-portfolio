# Tian Junwei | Data Analysis & AI Application Portfolio
...
- **可视化**：Matplotlib, Data Visualization
- **AI / 建模**：PyTorch, Physics-Informed Neural Networks (PINN), YOLOv8 / Ultralytics
